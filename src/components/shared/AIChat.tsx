...
export default function AIChat() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      content: 'Hi there! 👋 I\'m your AI assistant. How can I help you with your campaigns today?',
      sender: 'ai',
      timestamp: new Date()
    }
  ]);
        ...
        <div className="flex-1 overflow-y-auto p-4 bg-gray-50" style={{ maxHeight: '400px' }}>
          ...
          {isTyping && (
            <div className="flex justify-start mb-3">
              <div className="px-4 py-2 rounded-2xl max-w-[80%] bg-white border border-gray-100 shadow-sm rounded-tl-none">
