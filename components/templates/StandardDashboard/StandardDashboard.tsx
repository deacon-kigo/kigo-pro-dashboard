                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="font-semibold text-white">
                        Hey {userProfile?.name?.split(" ")[0] || "User"}, I'm
                        your AI Assistant
                      </h3>
                    ...
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          Deacon&apos;s Pizza requesting special discount
                          approval for upcoming holiday promotion
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="p-3 border border-gray-100 rounded-lg">
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          Review Deacon&apos;s Pizza summer campaign performance
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="p-2 bg-yellow-100 rounded-md mr-3 flex-shrink-0">
                        ...
                        >
                          ...
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={2}
                            d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-3.943 7.864-7 12.342-7C20.477 5 24.268 7.943 25.542 12c-1.274 4.057-3.943 7.864-7.864 9.138-4.057 1.274-7.864-2.477-9.138-6.534-7.864z"
                          />
                        </svg>
                      </div>
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          New analysis shows that &quot;Buy One Get One&quot;
                          offers generate 32% more engagement than flat
                          discounts
                        </div>
                      </div>
                    </div>
