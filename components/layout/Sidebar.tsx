    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className="mt-6 mb-6 flex-1 overflow-y-auto">
          {!isCollapsed && <p className="text-xs font-medium text-text-muted px-5 uppercase tracking-wider mb-2">Main</p>}
          ...
          <div className={`flex items-center ${isCollapsed ? 'justify-center' : ''} pb-6`}>
            ...
            {!isCollapsed && (
              <div className="ml-3 overflow-hidden">
                <p className="font-semibold text-sm whitespace-nowrap overflow-hidden text-ellipsis">Jane Doe</p>
                <p className="text-xs text-text-muted">Campaign Manager</p>
              </div>
            )}
          </div>
        </div>
