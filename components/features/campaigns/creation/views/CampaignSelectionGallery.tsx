            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-blue-600">
                  The most effective local campaigns combine specific audience
                  targeting, compelling offers with clear value propositions,
                  and consistent timing. Select a campaign that addresses your
                  current business challenges while providing room for
...
const CampaignCard: React.FC<{
  ...
  return (
    <motion.div
      ...
      onClick={onSelect}
      className="flex-shrink-0 w-[300px] bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden cursor-pointer transition-all duration-200"
    >
      {/* Image */}
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-2 gap-2 text-xs text-gray-500 mb-4">
          <div>
            ...
            <p className="font-medium text-gray-700">
              {campaign.estimatedReach.min.toLocaleString()}-
              {campaign.estimatedReach.max.toLocaleString()}
            </p>
          </div>
          <div>
        ...
        <div className="w-full py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg text-sm font-medium transition-colors text-center">
          Select Campaign
        </div>
      </div>
    </motion.div>
