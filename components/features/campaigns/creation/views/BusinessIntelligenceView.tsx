...
const BusinessIntelligenceView: React.FC<BusinessIntelligenceViewProps> = ({
  data,
}) => {
          ...
          <Card>
            ...
            <div className="mt-4 bg-blue-50 p-3 rounded-lg border border-blue-100">
              <div className="flex">
                ...
                <p className="text-sm text-gray-700">
                  <span className="font-semibold">Key Insight:</span>{" "}
                  {data.insights.performanceTrend}
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card>
            ...
            <div className="mt-4 bg-blue-50 p-3 rounded-lg border border-blue-100">
              <div className="flex">
                ...
                <p className="text-sm text-gray-700">
                  <span className="font-semibold">Key Insight:</span>{" "}
                  {data.insights.competitorActivity}
                </p>
              </div>
            </div>
          </Card>
