      ...
      setTimeout(
        () => {
          ...
          if (step.progress === 100) {
            setTimeout(() => {
              // Store campaign data including gift options from Sarah's demo
              const campaignData = {
                type: campaignType,
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-blue-50 rounded-lg">
                  ...
                  <div className="text-sm text-blue-800 space-y-1">
                    <div>• Gift Value: ${giftAmount}</div>
                    <div>• AI Personalization: Enabled</div>
                    <div>• Follow-up: Moving assistance inquiry</div>
                    <div>• Partner Bundle: U-Haul, Storage, Hotels</div>
                  </div>
                </div>

                <button
                  onClick={handleConfirmLaunch}
                  className="w-full py-3 px-6 bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-lg font-semibold hover:from-green-700 hover:to-blue-700 transition-all duration-200 shadow-lg"
                >
                  Launch Campaign
                </button>
              </div>
