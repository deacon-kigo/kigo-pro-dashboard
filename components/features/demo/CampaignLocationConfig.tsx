...
export function CampaignLocationConfig({
  ...
  const programData = {
    campaignName: "New Home Buyer and Moving Campaign",
      ...
      <div className="text-center mb-6">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <h3 className="text-lg font-bold text-gray-900">
            AI Optimized Campaign Configuration
          </h3>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm font-semibold text-gray-900 bg-purple-50 px-2 py-1 rounded">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm font-semibold text-gray-900 bg-orange-50 px-2 py-1 rounded">
                On demand
              </span>
            </div>
          </div>
      ...
      {showMerchantMap && (
        <div className="mb-6 bg-gradient-to-br from-green-50 via-white to-blue-50 rounded-xl border border-green-200 p-4 animate-in slide-in-from-bottom-2 fade-in">
          ...
          <div className="text-center mb-4">
            <button className="text-sm text-blue-600 hover:text-blue-700 font-medium hover:underline transition-colors bg-white px-3 py-2 rounded-lg border border-blue-200 hover:bg-blue-50 shadow-sm">
              See all network partners (20 total)
            </button>
            <p className="text-xs text-gray-500 mt-1">
              Showing first 4 of 20 relevant network partner brands
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="text-center bg-white rounded-lg p-4 border border-gray-200">
              ...
              <div className="text-xs text-gray-500 mt-1">
                The combination of offers, brands and locations delivers highly
