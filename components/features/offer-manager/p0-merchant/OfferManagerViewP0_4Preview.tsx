...
/**
 * Offer Manager P0.4 - Offer Preview
 *
 * This iteration adds the Offer Preview Panel to validate presentation before publish.
 * URL: /offer-manager?version=p0.4
 *
 * Features:
 * - All P0.2 merchant creation features
 * - Live Offer Preview Panel (Card View + Detail View)
 * - Visual verification for marketplace display
 */

interface OfferManagerViewP0_4PreviewProps {
...
export default function OfferManagerViewP0_4Preview({
  onCreatingChange,
  autoStart = false,
  onBackToDashboard,
}: OfferManagerViewP0_4PreviewProps = {}) {
  ...
  return (
    <div className="overflow-hidden" style={{ height: "calc(100vh - 140px)" }}>
      <div className="h-full flex gap-3">
        ...
        {/* Offer Preview Panel - Right Column */}
