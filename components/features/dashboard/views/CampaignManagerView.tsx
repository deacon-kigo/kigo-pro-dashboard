  ...
  return (
    <div className="space-y-4">
      ...
      <div 
        ...
        style={{ 
          background: "linear-gradient(135deg, rgba(226, 240, 253, 0.9), rgba(226, 232, 255, 0.85))",
          overflow: "hidden",
            ...
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold text-blue-600">
                  {currentGreeting}, <span className="text-purple-600">{userProfile?.name?.split(' ')[0] || 'User'}</span>!
                </h1>
...
const PowerBIEmbed = () => {
  const powerBIUrl = "https://app.powerbi.com/reportEmbed?reportId=cd3e45c5-bf62-4248-ae49-ba2fc0659afe&autoAuth=true&ctid=81549142-4900-41ac-a022-6ce1b9a87cd1";
