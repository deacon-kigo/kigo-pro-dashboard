...
const meta: Meta<typeof ElevationSystem> = {
  title: 'Kigo UI/Design System/Elevation',
  parameters: {
    docs: {
      description: {
...
const ShadowExample = ({ name, description, className, shadowClass, usageExamples }: ShadowExampleProps) => (
  <div className="mb-8">
    <h3 className="text-lg font-semibold mb-2">{name}</h3>
    <p className="text-sm text-text-muted mb-4">{description}</p>
    
    <div className="flex flex-wrap gap-8">
      <div className={`w-32 h-32 bg-white rounded-lg ${shadowClass} flex items-center justify-center ${className}`}>
        <span className="font-mono text-xs">{shadowClass}</span>
      </div>
      
      <div className="flex-1">
        <div className="mb-2 text-xs font-medium uppercase text-text-muted tracking-wider">Use Cases</div>
  ...
  render: () => (
    <div className="p-6 max-w-4xl">
      ...
      <p className="text-gray-600 mb-6">
        Kigo's elevation system uses shadows to express hierarchy, depth, and focus within the interface.
        Shadows help users understand which elements are interactive and which are at the forefront
        of the experience.
      </p>
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-5 rounded-lg border border-gray-100">
            ...
            <p className="text-sm">
              Use elevation purposefully to guide the user's attention and create meaningful hierarchy.
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-lg border border-gray-100">
            ...
            <p className="text-sm">
              Apply elevation consistently across products to establish predictable patterns.
            </p>
          </div>
        ...
        <div className="mb-12">
          ...
          <p className="text-sm text-text-muted mb-6">
            Shadows can be used to communicate interactive states, such as hover or active states.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              <div className="h-32 bg-white rounded-lg shadow-sm focus:shadow-md flex items-center justify-center mb-2">
                <button className="focus:outline-none w-full h-full">Focus Me</button>
              </div>
              <p className="text-xs text-center text-text-muted">
                Default → Focus<br />
        ...
        <div className="mb-10">
          ...
          <p className="text-sm text-text-muted mb-6">
            Example of how different elevation levels work together in an interface.
          </p>
          ...
          <div className="bg-gray-50 p-8 rounded-lg">
            ...
            <div className="shadow bg-white p-4 rounded-lg mb-6">
              ...
              <p className="text-sm mb-4">Main content area with standard elevation</p>
              
              <div className="shadow-md bg-white p-3 rounded-lg mb-3 border-l-4 border-primary">
                <p className="text-sm font-medium">Important Notice (shadow-md)</p>
                <p className="text-xs text-text-muted">Highlighted information with increased elevation</p>
              </div>
            ...
            <div className="relative">
              <div className="shadow-lg bg-white p-4 rounded-lg w-80 absolute right-0 z-10">
                ...
                <p className="text-sm">Higher elevation for overlaid UI elements</p>
        ...
        <div className="mb-10">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <p className="text-sm">
                Ensure there is sufficient contrast between elements with different elevations.
                Use color in addition to shadows to reinforce hierarchy for users with low vision.
              </p>
            </div>
            ...
            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <p className="text-sm">
                Use elevation changes in combination with color to make focus states clear and visible.
                Don't rely solely on shadows to indicate focus.
              </p>
            </div>
            ...
            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <p className="text-sm">
                Be mindful of users with motion sensitivity when animating shadow transitions.
                Keep animations subtle and respect user preferences for reduced motion.
              </p>
            </div>
          </div>
        </div>
