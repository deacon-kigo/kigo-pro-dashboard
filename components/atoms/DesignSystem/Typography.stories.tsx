    ...
    <div className="flex flex-wrap items-start mb-4">
      <div className="w-full md:w-1/4 mb-2 md:mb-0">
        ...
        <div className="mt-4 space-y-1">
          <p className="text-xs font-mono text-text-muted">Size: <span className="text-text-dark">{sizeClass}</span></p>
          <p className="text-xs font-mono text-text-muted">Weight: <span className="text-text-dark">{weightClass}</span></p>
          {lineHeightClass && (
            <p className="text-xs font-mono text-text-muted">Line Height: <span className="text-text-dark">{lineHeightClass}</span></p>
          )}
          <p className="text-xs font-mono text-text-muted">Font: <span className="text-text-dark">{fontClass}</span></p>
        </div>
      </div>
...
const meta: Meta<typeof TypographySystem> = {
  title: 'Kigo UI/Design System/Typography',
  parameters: {
    docs: {
      description: {
    ...
    <div className="p-6">
      ...
      <div className="mb-8 pb-8 border-b border-gray-200">
        <div className="mb-4">
          ...
          <p className="text-sm text-text-muted">Primary font family for all UI elements</p>
        </div>
        ...
        <div className="bg-white border border-gray-100 rounded-lg p-6 mb-6">
          ...
          <div className="font-sans">
            ...
            <p className="text-sm text-text-muted">
              <code className="text-xs bg-gray-100 px-1 py-0.5 rounded">font-sans</code> - Default sans-serif font for all UI elements
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div className="flex flex-wrap items-center">
          <div className="w-full md:w-1/4 mb-2 md:mb-0">
            ...
            <p className="text-xs text-text-muted mt-1">
              <code className="bg-gray-100 px-1 py-0.5 rounded">font-normal</code>
            </p>
          </div>
        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full md:w-1/4 mb-2 md:mb-0">
            ...
            <p className="text-xs text-text-muted mt-1">
              <code className="bg-gray-100 px-1 py-0.5 rounded">font-medium</code>
            </p>
          </div>
        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full md:w-1/4 mb-2 md:mb-0">
            ...
            <p className="text-xs text-text-muted mt-1">
              <code className="bg-gray-100 px-1 py-0.5 rounded">font-semibold</code>
            </p>
          </div>
        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full md:w-1/4 mb-2 md:mb-0">
            ...
            <p className="text-xs text-text-muted mt-1">
              <code className="bg-gray-100 px-1 py-0.5 rounded">font-extrabold</code>
            </p>
          </div>
        ...
        <div className="mb-4">
          <div className="flex flex-wrap">
            <div className="w-full md:w-1/4 mb-2 md:mb-0">
              ...
              <p className="text-xs text-text-muted mt-1">
                <code className="bg-gray-100 px-1 py-0.5 rounded">leading-tight</code>
              </p>
            </div>
            <div className="w-full md:w-3/4">
              <p className="leading-tight bg-pastel-blue bg-opacity-30 p-4 rounded">
                This text has tight line height (16px).<br />
        ...
        <div className="mb-4">
          <div className="flex flex-wrap">
            <div className="w-full md:w-1/4 mb-2 md:mb-0">
              ...
              <p className="text-xs text-text-muted mt-1">
                <code className="bg-gray-100 px-1 py-0.5 rounded">leading-snug</code>
              </p>
            </div>
            <div className="w-full md:w-3/4">
              <p className="leading-snug bg-pastel-green bg-opacity-30 p-4 rounded">
                This text has snug line height (20px).<br />
                The quick brown fox jumps over the lazy dog. The five boxing wizards jump quickly. How vexingly quick daft zebras jump!
              </p>
            </div>
          </div>
        ...
        <div className="mb-4">
          <div className="flex flex-wrap">
            <div className="w-full md:w-1/4 mb-2 md:mb-0">
              ...
              <p className="text-xs text-text-muted mt-1">
                <code className="bg-gray-100 px-1 py-0.5 rounded">leading-normal</code>
              </p>
            </div>
            <div className="w-full md:w-3/4">
              <p className="leading-normal bg-pastel-yellow bg-opacity-30 p-4 rounded">
                This text has normal line height (24px).<br />
                The quick brown fox jumps over the lazy dog. The five boxing wizards jump quickly. How vexingly quick daft zebras jump!
              </p>
            </div>
          </div>
        ...
        <div className="mb-4">
          <div className="flex flex-wrap">
            <div className="w-full md:w-1/4 mb-2 md:mb-0">
              ...
              <p className="text-xs text-text-muted mt-1">
                <code className="bg-gray-100 px-1 py-0.5 rounded">leading-relaxed</code>
              </p>
            </div>
            <div className="w-full md:w-3/4">
              <p className="leading-relaxed bg-pastel-orange bg-opacity-30 p-4 rounded">
                This text has relaxed line height (28px).<br />
                The quick brown fox jumps over the lazy dog. The five boxing wizards jump quickly. How vexingly quick daft zebras jump!
              </p>
            </div>
          </div>
        ...
        <div className="mb-4">
          <div className="flex flex-wrap">
            <div className="w-full md:w-1/4 mb-2 md:mb-0">
              ...
              <p className="text-xs text-text-muted mt-1">
                <code className="bg-gray-100 px-1 py-0.5 rounded">leading-loose</code>
              </p>
            </div>
            <div className="w-full md:w-3/4">
              <p className="leading-loose bg-pastel-purple bg-opacity-30 p-4 rounded">
                This text has loose line height (40px).<br />
                The quick brown fox jumps over the lazy dog. The five boxing wizards jump quickly. How vexingly quick daft zebras jump!
              </p>
            </div>
          </div>
