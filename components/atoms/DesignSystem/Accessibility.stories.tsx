...
const meta: Meta<typeof AccessibilityGuidelines> = {
  title: 'Kigo UI/Design System/Accessibility',
  parameters: {
    docs: {
      description: {
...
// Helper components
const GuidelineSection = ({ title, children }: { title: string, children: React.ReactNode }) => (
  <div className="mb-10">
    <h2 className="text-xl font-bold mb-4 pb-2 border-b border-gray-200">{title}</h2>
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        {goodExample && (
          <div className="bg-pastel-green bg-opacity-20 border border-green-100 rounded-lg p-4">
            <div className="flex items-center mb-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-green mr-2">
        ...
        {badExample && (
          <div className="bg-pastel-red bg-opacity-20 border border-red-100 rounded-lg p-4">
            <div className="flex items-center mb-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-red mr-2">
    ...
    <div className="p-6 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-text-muted">
          Our accessibility guidelines ensure that Kigo products are usable by everyone. 
          We follow WCAG 2.1 AA standards in our design and implementation.
        </p>
      </div>
      ...
      <GuidelineSection title="Color & Contrast">
        <Guideline
          ...
          goodExample={
            <div>
              <p className="text-text-dark bg-white p-3 mb-2 rounded">This text has sufficient contrast (Dark text on white background - ratio: 12:1)</p>
              <p className="bg-primary text-white p-3 rounded">This text has sufficient contrast (White text on primary blue - ratio: 4.6:1)</p>
            </div>
          }
          badExample={
            <div>
              <p className="text-gray-400 bg-white p-3 mb-2 rounded">This text has poor contrast (Light gray on white - ratio: 2.5:1)</p>
              <p className="bg-pastel-blue text-blue-300 p-3 rounded">This text has poor contrast (Light blue on pastel blue - ratio: 1.8:1)</p>
            </div>
          }
        />
        ...
        <Guideline
          ...
          goodExample={
            <div className="flex gap-4">
              <button className="bg-primary text-white px-4 py-2 rounded-lg">Primary Button</button>
              <button className="bg-white border-2 border-primary text-primary px-4 py-2 rounded-lg">Outline Button</button>
            </div>
          }
          badExample={
            <div className="flex gap-4">
              <button className="bg-pastel-blue text-blue-300 px-4 py-2 rounded-lg">Low Contrast Button</button>
              <button className="bg-white border border-gray-200 text-gray-300 px-4 py-2 rounded-lg">Low Contrast Outline</button>
            </div>
          }
        />
        ...
        <Guideline
          ...
          goodExample={
            <div className="flex flex-col gap-3">
              <button className="focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 bg-primary text-white px-4 py-2 rounded">Button with visible focus ring</button>
              <a href="#" className="focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 text-primary underline">Link with visible focus ring</a>
            </div>
          }
          badExample={
            <div className="flex flex-col gap-3">
              <button className="focus:outline-none bg-primary text-white px-4 py-2 rounded">Button with no focus indicator</button>
              <a href="#" className="focus:outline-none text-primary">Link with no focus indicator</a>
            </div>
          }
        />
      ...
      <GuidelineSection title="Form Elements">
        <Guideline
          ...
          goodExample={
            <div className="mb-4">
              <label htmlFor="example-input" className="block text-sm font-medium mb-1">Email Address</label>
              <input 
                type="email" 
                id="example-input" 
        ...
        <Guideline
          ...
          goodExample={
            <div className="mb-4">
              <label htmlFor="password-good" className="block text-sm font-medium mb-1">Password</label>
              <input 
                type="password" 
                id="password-good" 
              ...
              />
              <p id="password-error-good" className="mt-2 text-red text-sm">Password must be at least 8 characters and include at least one number and one special character.</p>
            </div>
          }
          badExample={
            <div className="mb-4">
              <label htmlFor="password-bad" className="block text-sm font-medium mb-1">Password</label>
              <input 
                type="password" 
                id="password-bad" 
                className="border border-red-300 rounded-md px-3 py-2 w-full"
      ...
      <GuidelineSection title="Images & Media">
        <Guideline
          ...
          goodExample={
            <div className="border border-gray-200 rounded p-2 text-sm">
              <code>
                &lt;img src="chart-sales-data.png" alt="Bar chart showing monthly sales data from January to December 2023, with peak sales in November." /&gt;
              </code>
            </div>
          }
          badExample={
            <div className="border border-gray-200 rounded p-2 text-sm">
              <code>
                &lt;img src="chart.png" alt="Chart" /&gt;<br />
