...
const meta: Meta<typeof SpacingSystem> = {
  title: 'Kigo UI/Design System/Spacing',
  parameters: {
    docs: {
      description: {
        component: 'Spacing system and layout guidelines for the Kigo design system.'
      },
    },
  },
};
...
const SpacingExample = ({ name, value, className = '' }: SpacingExampleProps) => (
  <div className="mb-6">
...
const GridExample = ({ title, children }: { title: string, children: React.ReactNode }) => (
  <div className="mb-10">
...
export const SpacingGuidelines: Story = {
  render: () => (
    <div className="p-6 max-w-4xl">
      ...
      <div className="mb-10">
        <p className="mb-4">
          The Kigo design system uses a consistent spacing scale based on 4px increments. 
          This spacing scale is used for margins, paddings, and layout gaps to ensure 
        ...
        <div className="space-y-4 mb-8">
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <ul className="list-disc ml-5 space-y-1 text-sm">
              <li><strong>xs (4px)</strong>: For minimal spacing within compact components</li>
              <li><strong>sm (8px)</strong>: Default padding for buttons, input fields</li>
              <li><strong>md (12px)</strong>: Standard padding for cards, modals</li>
              <li><strong>lg (16px)</strong>: Generous padding for containers and sections</li>
            </ul>
          </div>
          ...
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <ul className="list-disc ml-5 space-y-1 text-sm">
              <li><strong>md-2xl (12-24px)</strong>: For spacing between related elements</li>
              <li><strong>3xl-4xl (32-40px)</strong>: For spacing between content sections</li>
              <li><strong>5xl+ (48px+)</strong>: For major page sections and vertical rhythm</li>
            </ul>
          </div>
          ...
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <ul className="list-disc ml-5 space-y-1 text-sm">
              <li><strong>sm (8px)</strong>: Default padding inside form elements</li>
              <li><strong>md-lg (12-16px)</strong>: Spacing between form fields</li>
              <li><strong>xl-2xl (20-24px)</strong>: Spacing between form sections</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="mb-10">
        ...
        <p className="mb-4">
          Kigo uses a flexible 12-column grid system for layouts. The grid system helps 
          create consistent, responsive layouts across different viewport sizes.
        </p>
        ...
        <GridExample title="Common Layout Patterns">
          <div className="space-y-8">
            <div>
              <p className="text-sm mb-2 font-medium">Two equal columns (6/6)</p>
              <div className="grid grid-cols-12 gap-4">
            ...
            <div>
              <p className="text-sm mb-2 font-medium">Three equal columns (4/4/4)</p>
              <div className="grid grid-cols-12 gap-4">
            ...
            <div>
              <p className="text-sm mb-2 font-medium">Content with sidebars (3/6/3)</p>
              <div className="grid grid-cols-12 gap-4">
                <div className="col-span-3">
        ...
        <GridExample title="Responsive Behavior">
          <div className="space-y-8">
            <div>
              <p className="text-sm mb-2 font-medium">Stack on mobile, side-by-side on desktop</p>
            ...
            <div>
              <p className="text-sm mb-2 font-medium">One column on mobile, three on desktop</p>
      ...
      <div className="mb-10">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-lg font-semibold mb-2">Small Container (640px)</h3>
            <div className="mx-auto max-w-sm border-2 border-dashed border-primary p-4 rounded">
              <div className="text-center text-sm">For dialogs, modals, and narrow content</div>
            </div>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-2">Medium Container (768px)</h3>
            <div className="mx-auto max-w-md border-2 border-dashed border-primary p-4 rounded">
              <div className="text-center text-sm">For forms, sign-up flows, and focused content</div>
            </div>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-2">Large Container (1024px)</h3>
            <div className="mx-auto max-w-lg border-2 border-dashed border-primary p-4 rounded">
              <div className="text-center text-sm">For standard content pages</div>
            </div>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-2">Extra Large Container (1280px)</h3>
            <div className="mx-auto max-w-xl border-2 border-dashed border-primary p-4 rounded">
              <div className="text-center text-sm">For dashboards and data-rich pages</div>
            </div>
          </div>
        </div>
      </div>
