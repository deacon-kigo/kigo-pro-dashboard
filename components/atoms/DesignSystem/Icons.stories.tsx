...
const meta: Meta<typeof IconSystem> = {
  title: 'Kigo UI/Design System/Icons',
  parameters: {
    docs: {
      description: {
        component: 'Icon system and usage guidelines for the Kigo design system.'
      },
    },
  },
};
...
const IconDisplay = ({ name, icon, category }: IconExampleProps) => (
  <div className="flex flex-col items-center text-center">
    <div className="w-14 h-14 bg-gray-50 rounded-lg flex items-center justify-center mb-2">
      <div className="w-6 h-6 text-text-dark">
        {icon}
      </div>
    </div>
  ...
  render: () => (
    <div className="p-6 max-w-4xl">
      ...
      <p className="text-gray-600 mb-6">
        Kigo uses Heroicons as its primary icon library. Icons provide visual cues to help users
        navigate and interact with our interfaces. They should be used consistently and
        purposefully throughout the product.
      </p>
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-5 rounded-lg border border-gray-100">
            ...
            <p className="text-sm">
              Icons should clearly convey their meaning and function, with recognizable and universally understood symbols.
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-lg border border-gray-100">
            ...
            <p className="text-sm">
              Use icons consistently across products to establish a familiar visual language for users.
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-lg border border-gray-100">
            ...
            <p className="text-sm">
              Icons should be simple and focused on core ideas, avoiding unnecessary details or complexity.
            </p>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="mb-8">
            <h4 className="text-md font-semibold mb-4 text-text-dark border-b pb-2">Navigation Icons</h4>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 mb-6">
              {navigationIcons.map((icon, index) => (
                <IconDisplay key={index} name={icon.name} icon={icon.icon} category={icon.category} />
              ))}
            </div>
          </div>
          
          <div className="mb-8">
            <h4 className="text-md font-semibold mb-4 text-text-dark border-b pb-2">Action Icons</h4>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 mb-6">
          ...
          <div className="mb-8">
            <h4 className="text-md font-semibold mb-4 text-text-dark border-b pb-2">Direction Icons</h4>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 mb-6">
          ...
          <div className="mb-8">
            <h4 className="text-md font-semibold mb-4 text-text-dark border-b pb-2">Status Icons</h4>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 mb-6">
        ...
        <div className="mb-12">
          ...
          <p className="text-sm text-text-muted mb-6">
            Icons come in different sizes for different contexts. Choose the appropriate size for your use case.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs font-medium text-text-dark">XS (16px)</span>
              <span className="text-xs text-text-muted">w-4 h-4</span>
              <p className="text-xs text-text-muted text-center mt-2">Badges, tight spaces</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs font-medium text-text-dark">SM (20px)</span>
              <span className="text-xs text-text-muted">w-5 h-5</span>
              <p className="text-xs text-text-muted text-center mt-2">Buttons, form elements</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs font-medium text-text-dark">MD (24px)</span>
              <span className="text-xs text-text-muted">w-6 h-6</span>
              <p className="text-xs text-text-muted text-center mt-2">General UI, navigation</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs font-medium text-text-dark">LG (32px)</span>
              <span className="text-xs text-text-muted">w-8 h-8</span>
              <p className="text-xs text-text-muted text-center mt-2">Feature highlights, headers</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <p className="text-sm text-text-muted mb-6">
            Icons are most effective when paired with text to reinforce meaning and enhance comprehension.
          </p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg border border-gray-100 p-4">
              ...
              <div className="space-y-2">
                <a href="#" className="flex items-center py-2 px-3 bg-blue-50 text-primary rounded-lg">
                  <HomeIcon className="w-5 h-5 mr-3" />
                  <span>Dashboard</span>
                </a>
                
                <a href="#" className="flex items-center py-2 px-3 text-text-dark hover:bg-gray-50 rounded-lg">
        ...
        <div className="mb-10">
          <h3 className="text-lg font-bold mb-4">Accessibility Considerations</h3>
          
          <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
              <h4 className="font-semibold mb-2">Text Labels</h4>
              <p className="text-sm">
                Always include text alongside icons to ensure users understand their meaning.
                For icon-only buttons, include aria-label attributes for screen readers.
              </p>
              <div className="mt-4 bg-gray-100 p-3 rounded-md">
                <pre className="text-xs font-mono">
                  &lt;button aria-label="Delete item"&gt;<br />
                  &nbsp;&nbsp;&lt;TrashIcon className="w-5 h-5" /&gt;<br />
                  &lt;/button&gt;
                </pre>
              </div>
            </div>
            ...
            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <p className="text-sm">
                Ensure icons have sufficient color contrast against their background.
            ...
            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <p className="text-sm">
                ...
                For interactive icons, maintain a minimum touch target size of 44×44 pixels.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-10">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <p className="text-sm mb-4">
              Kigo uses Heroicons. Import icons from the appropriate package based on your needs:
            </p>
            <div className="bg-gray-100 p-3 rounded-md">
              <pre className="text-xs font-mono">
                // For outline style (preferred)<br />
                import &#123; UserIcon &#125; from '@heroicons/react/24/outline';<br />
                <br />
                // For solid style<br />
                import &#123; UserIcon &#125; from '@heroicons/react/24/solid';<br />
                <br />
                // For mini style<br />
            ...
            <div className="bg-gray-100 p-3 rounded-md">
              <pre className="text-xs font-mono">
                // Standard usage with size classes<br />
                &lt;UserIcon className="w-6 h-6" /&gt;<br />
                <br />
                // With colors<br />
                &lt;UserIcon className="w-6 h-6 text-primary" /&gt;<br />
                <br />
                // In a button with text<br />
                &lt;button className="flex items-center"&gt;<br />
                &nbsp;&nbsp;&lt;UserIcon className="w-5 h-5 mr-2" /&gt;<br />
                &nbsp;&nbsp;Profile<br />
                &lt;/button&gt;
              </pre>
            </div>
