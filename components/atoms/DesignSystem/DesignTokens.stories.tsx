...
const meta: Meta<typeof DesignTokens> = {
  title: 'Kigo UI/Design System/Design Tokens',
  parameters: {
    docs: {
      description: {
...
const TokenRow = ({ name, value, variableName, preview, description }: TokenRowProps) => (
  <div className="flex items-center py-3 border-b border-gray-100 text-sm">
    ...
    {variableName && <div className="w-1/4 font-mono text-xs text-text-muted">--{variableName}</div>}
    {description && <div className="w-1/4 text-xs text-text-muted">{description}</div>}
  </div>
);
...
const ColorToken = ({ name, value, variableName, description }: ColorTokenProps) => (
  <TokenRow
    name={name}
    value={value}
    variableName={variableName}
    preview={<div className="w-8 h-8 rounded-md" style={{ backgroundColor: value }}></div>}
...
const SpacingToken = ({ name, value, variableName, description }: SpacingTokenProps) => (
  <TokenRow
    name={name}
    value={value}
    variableName={variableName}
    preview={<div className="bg-gray-200" style={{ width: value, height: '8px' }}></div>}
    description={description}
  />
);
...
const FontToken = ({ name, value, variableName, description }: FontTokenProps) => (
  <TokenRow
    name={name}
    value={value}
    variableName={variableName}
...
const RadiusToken = ({ name, value, variableName, description }: RadiusTokenProps) => (
  <TokenRow
    name={name}
    value={value}
    variableName={variableName}
  ...
  render: () => (
    <div className="p-6 max-w-4xl">
      ...
      <p className="text-gray-600 mb-6">
        ...
        We use them in place of hardcoded values to ensure flexibility and maintain a consistent visual language across platforms and devices.
      </p>
      ...
      <div className="mb-12">
        ...
        <div className="bg-gray-50 p-5 rounded-lg border border-gray-100 mb-6">
          ...
          <p className="text-sm mb-4">
            Design tokens are the single source of truth for the design language within our
            system. They represent the smallest visual attributes such as:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-xs text-text-muted">
                Tokens ensure consistent visual language across different platforms and components.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-xs text-text-muted">
                Changes to tokens propagate throughout the entire system, enabling themes and style changes at scale.
              </p>
            </div>
            <div>
              <h5 className="font-medium text-sm mb-2">Maintenance</h5>
              <p className="text-xs text-text-muted">
                Centralized approach makes it easier to maintain and evolve the design system.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mb-12">
        ...
        <div className="mb-6">
          <h4 className="text-md font-semibold mb-4 pb-2 border-b">Brand Colors</h4>
          <div>
            <ColorToken 
              name="Brand / Primary" 
              value="#0066FF" 
        ...
        <div className="mb-6">
          <h4 className="text-md font-semibold mb-4 pb-2 border-b">Text Colors</h4>
          <div>
            <ColorToken 
              name="Text / Dark" 
              value="#101828" 
        ...
        <div className="mb-6">
          <h4 className="text-md font-semibold mb-4 pb-2 border-b">Status Colors</h4>
          <div>
            <ColorToken 
              name="Status / Success" 
              value="#12B76A" 
        ...
        <div className="mb-6">
          <h4 className="text-md font-semibold mb-4 pb-2 border-b">Background Colors</h4>
          <div>
            <ColorToken 
      ...
      <div className="mb-12">
        ...
        <div className="mb-6">
          <p className="text-sm text-text-muted mb-4">
            Our spacing system is built on 4px increments, providing a consistent rhythm across interfaces.
          </p>
      ...
      <div className="mb-12">
        ...
        <p className="text-sm text-text-muted mb-4">
          Border radius tokens define the roundness of UI elements, providing a consistent look and feel.
        </p>
      ...
      <div className="mb-12">
        ...
        <p className="text-sm text-text-muted mb-4">
          Typography tokens establish a consistent type scale and font settings across the UI.
        </p>
        
        <div className="mb-6">
          <h4 className="text-md font-semibold mb-4 pb-2 border-b">Font Family</h4>
          <div>
            <FontToken 
              name="Font Primary" 
        ...
        <div className="mb-6">
          <h4 className="text-md font-semibold mb-4 pb-2 border-b">Font Weights</h4>
          <div>
            <TokenRow 
              name="Font Regular" 
              value="400" 
        ...
        <div className="mb-6">
          <h4 className="text-md font-semibold mb-4 pb-2 border-b">Font Sizes</h4>
          <div>
            <TokenRow 
              name="Font XS" 
              value="12px" 
        ...
        <div className="mb-6">
          <h4 className="text-md font-semibold mb-4 pb-2 border-b">Line Heights</h4>
          <div>
            <TokenRow 
              name="Leading None" 
              value="1" 
      ...
      <div className="mb-12">
        ...
        <p className="text-sm text-text-muted mb-4">
          Shadow tokens define elevation and depth within the UI, creating a sense of hierarchy and focus.
        </p>
        
        <div>
          <div className="py-4 flex items-center border-b border-gray-100">
            <div className="w-1/4 font-medium text-sm text-text-dark">Shadow / None</div>
          ...
          <div className="py-4 flex items-center border-b border-gray-100">
            <div className="w-1/4 font-medium text-sm text-text-dark">Shadow / XS</div>
            <div className="w-1/4 flex justify-center">
              <div className="w-16 h-16 bg-white shadow-sm"></div>
            </div>
            <div className="w-1/2 font-mono text-xs text-text-muted">
              box-shadow: 0px 1px 2px rgba(16, 24, 40, 0.05);<br />
              --shadow-xs
            </div>
          </div>
          
          <div className="py-4 flex items-center border-b border-gray-100">
            <div className="w-1/4 font-medium text-sm text-text-dark">Shadow / SM</div>
            <div className="w-1/4 flex justify-center">
              <div className="w-16 h-16 bg-white shadow"></div>
            </div>
            <div className="w-1/2 font-mono text-xs text-text-muted">
              box-shadow: 0px 1px 3px rgba(16, 24, 40, 0.1), 0px 1px 2px rgba(16, 24, 40, 0.06);<br />
              --shadow-sm
            </div>
          </div>
          
          <div className="py-4 flex items-center border-b border-gray-100">
            <div className="w-1/4 font-medium text-sm text-text-dark">Shadow / MD</div>
            <div className="w-1/4 flex justify-center">
              <div className="w-16 h-16 bg-white shadow-md"></div>
            </div>
            <div className="w-1/2 font-mono text-xs text-text-muted">
              box-shadow: 0px 4px 6px -1px rgba(16, 24, 40, 0.1), 0px 2px 4px -2px rgba(16, 24, 40, 0.06);<br />
              --shadow-md
            </div>
          </div>
          
          <div className="py-4 flex items-center border-b border-gray-100">
            <div className="w-1/4 font-medium text-sm text-text-dark">Shadow / LG</div>
            <div className="w-1/4 flex justify-center">
              <div className="w-16 h-16 bg-white shadow-lg"></div>
            </div>
            <div className="w-1/2 font-mono text-xs text-text-muted">
              box-shadow: 0px 10px 15px -3px rgba(16, 24, 40, 0.1), 0px 4px 6px -4px rgba(16, 24, 40, 0.05);<br />
              --shadow-lg
            </div>
          </div>
          
          <div className="py-4 flex items-center border-b border-gray-100">
            <div className="w-1/4 font-medium text-sm text-text-dark">Shadow / XL</div>
            <div className="w-1/4 flex justify-center">
              <div className="w-16 h-16 bg-white shadow-xl"></div>
            </div>
            <div className="w-1/2 font-mono text-xs text-text-muted">
              box-shadow: 0px 20px 25px -5px rgba(16, 24, 40, 0.1), 0px 8px 10px -6px rgba(16, 24, 40, 0.05);<br />
              --shadow-xl
            </div>
          </div>
          
          <div className="py-4 flex items-center border-b border-gray-100">
            <div className="w-1/4 font-medium text-sm text-text-dark">Shadow / 2XL</div>
            <div className="w-1/4 flex justify-center">
              <div className="w-16 h-16 bg-white shadow-2xl"></div>
            </div>
            <div className="w-1/2 font-mono text-xs text-text-muted">
              box-shadow: 0px 25px 50px -12px rgba(16, 24, 40, 0.25);<br />
              --shadow-2xl
            </div>
          </div>
        </div>
      ...
      <div className="mb-10">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg border border-gray-100 p-5">
            ...
            <p className="text-sm mb-4">
              Our design tokens are implemented as CSS custom properties (variables) for use in stylesheets:
            </p>
          ...
          <div className="bg-white rounded-lg border border-gray-100 p-5">
            ...
            <p className="text-sm mb-4">
              When using Tailwind CSS, our tokens are mapped to the theme configuration:
            </p>
            <div className="bg-gray-50 p-3 rounded-md">
              <pre className="text-xs font-mono">
                /* In JSX with Tailwind classes */
                &lt;button className="bg-primary px-4 py-2 rounded-md font-medium shadow-sm"&gt;
                  Button Text
                &lt;/button&gt;
              </pre>
            </div>
          ...
          <div className="bg-white rounded-lg border border-gray-100 p-5">
            ...
            <p className="text-sm mb-4">
              For dynamic styling or theme manipulation, tokens are also available in JavaScript:
            </p>
            <div className="bg-gray-50 p-3 rounded-md">
              <pre className="text-xs font-mono">
                // In JavaScript/TypeScript
                import &#123; tokens &#125; from '@kigo/design-tokens';
                
                const styles = &#123;
                  backgroundColor: tokens.colors.primary,
                  padding: `$&#123;tokens.spacing[8]&#125;px $&#123;tokens.spacing[16]&#125;px`,
      ...
      <div className="mb-10">
        ...
        <div className="space-y-4">
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <p className="text-sm">
              Design tokens follow semantic versioning. Major changes that might break existing implementations 
              will be released with a major version bump.
            </p>
          </div>
          ...
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <p className="text-sm">
              New tokens should be proposed and reviewed by both design and development teams before being added to the system.
              Always consider backward compatibility and the potential impact on existing components.
            </p>
          </div>
          ...
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <p className="text-sm">
              Tokens being deprecated will be marked as such for at least one full release cycle before being removed, 
              giving teams time to update their implementations.
            </p>
          </div>
        </div>
      </div>
