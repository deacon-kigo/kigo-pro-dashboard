...
interface JessicaDashboardProps {
...
export function JessicaDashboard({
  showNotification,
  onNotificationClick,
  onNotificationDismiss,
  onNavigate,
}: JessicaDashboardProps) {
      ...
      <div className="relative animate-fade-in">
        ...
        {showNotification && (
          <div className="mx-6 my-4 animate-fade-in">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, #fee2e2 0%, #fecaca 50%, #e8293c 100%)",
                borderColor: "#dc1c2e",
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.background =
                  "linear-gradient(135deg, #fecaca 0%, #e8293c 50%, #dc1c2e 100%)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background =
                  "linear-gradient(135deg, #fee2e2 0%, #fecaca 50%, #e8293c 100%)";
            ...
            >
              ...
              <button
                ...
                className="p-1 text-red-600 hover:text-blue-800 transition-colors"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
        ...
        <div className="mb-8">
          <div className="flex gap-4 overflow-x-auto pb-2 pl-6 pr-4 scrollbar-hide">
            ...
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #dc1c2e 0%, #9b1220 100%)",
                boxShadow:
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-red-200 text-xs font-medium">12/28</span>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div className="px-2 py-1 bg-white rounded border border-gray-300 flex items-center justify-center">
                    <span className="text-red-600 text-xs font-black tracking-wider">
                      VISA
                    </span>
                  </div>
        ...
        <div className="px-6 mb-8">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-bold text-gray-900">Open an account</h3>
            <button className="text-red-600 font-semibold text-sm px-3 py-1 rounded-lg hover:bg-red-50 transition-colors">
              All
            </button>
          </div>
        ...
        <div className="px-6 mb-6">
          <div
            ...
            style={{
              background: "linear-gradient(90deg, #fecaca 0%, #e8293c 100%)",
              borderColor: "#dc1c2e",
              borderWidth: "1px",
              boxShadow:
                "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)",
