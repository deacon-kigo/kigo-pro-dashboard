...
export function OffersBanner({ onTap }: OffersBannerProps) {
  ...
  return (
    <div className="relative mx-6 my-4">
      ...
      {/* Banner Content */}
      <div
        className="bg-gradient-to-r from-red-50 to-blue-100 rounded-xl p-4 flex items-center gap-3 cursor-pointer hover:from-red-100 hover:to-blue-200 transition-all duration-200 active:scale-98"
        onClick={onTap}
      >
        {/* Icon */}
