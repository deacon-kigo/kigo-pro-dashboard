...
export function CoffeeConquestCampaign({
  ...
  const handleSimulateTransaction = () => {
    ...
    // Simulate Jessica going to Starbucks and making a purchase
    setTimeout(() => {
      ...
      <div className="relative animate-fade-in">
        ...
        <div className="flex-1 p-6 space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 text-white">
            ...
            <div className="space-y-3">
              <p className="text-blue-50">
                Time for a new coffee routine, Jessica? Earn bonus points when
                you try Starbucks with your RE/MAX card!
              </p>
              ...
              <div className="text-blue-100 text-sm space-y-1">
                ...
                <p>• Use your RE/MAX card at any Starbucks</p>
          ...
          <p className="text-gray-500 text-xs text-center">
            Points will be automatically added to your RE/MAX account when you
            make a purchase
          </p>
        </div>
      </div>
    ...
    <MobileLayout>
      <div className="relative animate-fade-in">
        ...
        <div className="flex-1 p-6 space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 text-white">
            <div className="text-center mb-4">
              ...
              <p className="text-blue-100">
                Visit any Starbucks location and pay with your RE/MAX card to
                earn bonus points
              </p>
            </div>
          ...
          <p className="text-gray-500 text-xs text-center">
            (Demo: This simulates Jessica making a purchase)
          </p>
        </div>
      </div>
    </MobileLayout>
    ...
    <div className="w-full h-full bg-white flex flex-col">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          {/* RE/MAX Card - highlighted */}
          <div className="bg-blue-50 border-2 border-blue-200 rounded-2xl p-4">
            <div className="flex items-center space-x-4">
              <div className="w-12 h-8 bg-blue-600 rounded flex items-center justify-center">
                <span className="text-white text-xs font-bold">R/M</span>
              </div>
              <div className="flex-1">
                <div className="font-bold text-gray-900">RE/MAX Debit Card</div>
        ...
        >
          {isProcessing ? (
            ...
            "Pay $2.45 with RE/MAX Card"
          )}
        </button>

        {/* Security note */}
        <p className="text-center text-xs text-gray-500">
          🔒 Secure payment powered by RE/MAX
        </p>
      </div>
    </div>
  );
