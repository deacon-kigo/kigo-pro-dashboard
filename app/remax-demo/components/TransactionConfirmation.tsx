...
export function TransactionConfirmation({
  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-green-50 to-red-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-3/4 right-1/4 w-24 h-24 bg-red-100/50 rounded-full animate-pulse delay-1000"></div>
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center p-6 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-gray-700">
            Thank you for trying Starbucks,Jessica!
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-sm space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium">RE/MAX •••• 4567</span>
            </div>
        ...
        <button
          onClick={onComplete}
          className="bg-red-600 text-white font-bold py-3 px-8 rounded-2xl hover:bg-blue-700 transition-colors"
        >
          Continue Demo
        </button>
      </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between mb-1">
                <h4 className="font-semibold text-gray-900 text-sm">RE/MAX</h4>
