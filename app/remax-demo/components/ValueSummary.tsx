    ...
    <MobileLayout>
      ...
      <div className="px-6 py-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="font-semibold text-gray-900 text-lg">Jessica T.</p>
          </div>
        </div>
        <div className="flex items-center gap-4">
      ...
      <div className="px-6 mb-6">
        <div className="grid grid-cols-2 gap-4 mb-4">
          {/* Total Savings */}
          <div className="bg-gradient-to-br from-red-50 to-blue-100 rounded-2xl p-4 relative overflow-hidden">
        ...
        {/* Achievement Banner */}
        <div className="bg-gradient-to-r from-purple-50 to-red-50 rounded-2xl p-4 border border-purple-100">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                "RE/MAX made our move so much easier. The AI found deals I never
