        ...
        <div className="bg-gradient-to-b from-green-50 to-white min-h-full flex items-center justify-center px-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">
              Your ${gift?.value} gift card for {gift?.title} has been added to
              your Kigo Hub
            </p>
        ...
        <div className="px-6 py-4">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 text-sm">
              Choose your $100 housewarming gift
            </p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            {gifts.map((gift) => (
              <div
                ...
                className="bg-white rounded-2xl shadow-sm p-4 cursor-pointer hover:shadow-md transition-all border border-gray-100 hover:border-blue-200"
              >
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 leading-relaxed">
                  Our AI selected these gifts based on your family profile
                  (married with 2 kids), your new Denver location, and popular
                  choices for new homeowners in your area.
                </p>
              </div>
            </div>
          </div>
